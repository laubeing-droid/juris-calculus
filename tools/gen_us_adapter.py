...
============================================================================
输入: D:/US_glossary_L0_unified.json (81 terms)
输出: D:/LegalOS/git/juris-calculus/configs/en_US/US_Adapter.yaml
      D:/LegalOS/git/juris-calculus/configs/en_US/L0_overrides_us.yaml
...
# 路径
# ═══════════════════════════════════════════
INPUT_JSON = Path("D:/US_glossary_L0_unified.json")
OUTPUT_ADAPTER = Path("D:/LegalOS/git/juris-calculus/configs/en_US/US_Adapter.yaml")
OUTPUT_OVERRIDES = Path("D:/LegalOS/git/juris-calculus/configs/en_US/L0_overrides_us.yaml")
...
def gen_adapter_py_code(L0_map: Dict[str, str]):
    ...
    output_path = Path("D:/LegalOS/git/juris-calculus/adapter/_us_L0_map_generated.py")
