...
CANDIDATES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "current_gap": "Full proof traces grow with relevant rule applications and can produce large certificates",
        ...
        "production_module": "audit.py; rendering.py",
        "capability_unlocked": "Storable, transmittable, independently verifiable proof chains for loaded packs",
