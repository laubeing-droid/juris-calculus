...
JC 不是案件管理系统。客户数据、商业规则包、律师工作流、诉讼执行和个人文风配置不进入公开仓库。
...
详细说明见 `docs/CLI.md`、`docs/AUDIT_BUNDLE.md`、`docs/RULE_PACKS.md`、`docs/WORKBUDDY.md` 和 `docs/MIGRATION_V2_TO_V3.md`。
...
当前本地基线为 Python 3.11 与 3.12 均 `484 passed, 38 skipped`；未实际运行的远端 CI 必须写 `NOT_EXECUTED`，不得写成通过。
