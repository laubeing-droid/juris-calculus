...
详细说明见 `docs/guides/CLI.md`、`docs/contracts/AUDIT_BUNDLE.md`、`docs/contracts/RULE_PACKS.md`、`docs/contracts/INPUT_AND_SEMANTIC_BOUNDARY.md`、`docs/contracts/FORMAL_RUNTIME_CONFORMANCE.md`、`docs/guides/WORKBUDDY.md` 和 `docs/guides/MIGRATION_V2_TO_V3.md`。
